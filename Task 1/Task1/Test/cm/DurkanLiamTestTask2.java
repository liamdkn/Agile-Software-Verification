...
class DurkanLiamTestTask2 {
    ...
    @Test
    public void durationTestCase5(){
        assertThrows(IllegalArgumentException.class, () -> {
            Period period = new Period(22,1);
        });
    }
    @Test
    public void durationTestCase6(){
        assertThrows(IllegalArgumentException.class, () -> {
            Period period = new Period(-3,16);
        });
    }
    @Test
    public void durationTestCase7(){
        assertThrows(IllegalArgumentException.class, () -> {
            Period period = new Period(13,-2);
        });
    }
    @Test
    public void durationTestCase8(){
        assertThrows(IllegalArgumentException.class, () -> {
            Period period = new Period(17,1);
        });
    }
    @Test
    public void durationTestCase9(){
        assertThrows(IllegalArgumentException.class, () -> {
            Period period = new Period(5,2);
        });
    }
    ...
    public void calculateTestCase7(){
        ...
        assertEquals(new BigDecimal("90.0"), rate.calculate(periodStay));
    }
}